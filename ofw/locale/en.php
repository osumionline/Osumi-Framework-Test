...
$locale = [
	...
	'TASK_COMPOSER' => 'Function to export an application with all its files to a single self-extracting php file',
	'TASK_COMPOSER_EXPORTING' => 'Exporting project',
	'TASK_COMPOSER_EXISTS' => "    Destiny file already existed, it has been deleted.\n\n",
	'TASK_COMPOSER_GETTING_FILES' => "  Getting folders and files to export...\n",
	'TASK_COMPOSER_EXPORTING_FILES' => "  Exporting %s files.\n",
	'TASK_COMPOSER_EXPORTING_FOLDERS' => "  Exporting %s folders.\n",
	'TASK_COMPOSER_GETTING_READY' => "  Preparing composer...\n",
	'TASK_COMPOSER_BASE_FOLDER' => 'BASE PATH',
	'TASK_COMPOSER_CREATE_FOLDERS' => 'CREATING FOLDERS',
